...
<div class="page-wrapper">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <!--end breadcrumb-->
      <form  method="post" action="<?php echo base_url();?>update-announcement" enctype="multipart/form-data">
                ...
                <div class=" row">
                  <div class="col-md-12 mt-3">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="announcement_description" id="announcement_description" required><?php echo $announcement[0]['announcement_description']?></textarea>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div data-target-input="nearest">
                            ...
                            <input type="hidden" name="announcement_image" value="<?php echo $announcement[0]['announcement_image']?>" class="form-control" id="announcement_image">
                            <?php
                                if(!empty($announcement[0]['announcement_image']))
                                {
                            ?>
                                    <img src="<?php echo base_url();?>uploads/announcement/<?php echo $announcement[0]['announcement_image']; ?>" height="100px"/>
                            <?php
                                }
                            ?>
                        </div>
