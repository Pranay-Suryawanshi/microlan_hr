  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add ToDo </div>
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add ToDo </li>
            </ol>
          </nav>
        </div>
      ...
      <!--end breadcrumb-->
      <form  method="post" action="<?php echo base_url();?>save-todo" enctype="multipart/form-data">
                ...
                <div class=" row">
                  ...
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="todo_description" id="todo_description" required></textarea>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                  ...
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="date" name="estimate_date" class="form-control" id="estimate_date">
                        </div>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="date" name="estimate_end_date" class="form-control" id="estimate_end_date">
                        </div>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="time" name="estimate_start_time" class="form-control" id="estimate_start_time">
                        </div>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="time" name="estimate_end_time" class="form-control" id="estimate_end_time">
                        </div>
                    </div>
                  </div>
                  <!-- <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="time" name="actual_start_time" class="form-control" id="actual_start_time">
                        </div>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="time" name="actual_end_time" class="form-control" id="actual_end_time">
                        </div>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime1" data-target-input="nearest">
                            <input type="time" name="pause_time" class="form-control" id="pause_time">
                        </div>
                    </div>
                  </div> -->
                  <div class="col-md-3 mt-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="todo_status" required>
                                ...
                                <option value="Waiting for Client Reply">Waiting for Client Reply</option>
