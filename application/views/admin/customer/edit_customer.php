                ...
                <div class=" row">
                  ...
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                      ...
                      <input type="text" oninput="restrictToNumbers(event)" maxlength="10" name="contact_person" class="form-control" id="contact_person" value="<?php echo $res['contact_person']; ?>"
