...
<div class="page-wrapper">
                                ...
                                <?php if (!empty($task_list)) {
                                  ...
                                  foreach ($task_list as $key_a => $value_tk) { ?>
                                    <tr data-task-id="<?php echo $value_tk['task_id']; ?>">
                                      ...
                                      <td>
                                        <?php if ($value_tk['task_status'] == '2' || $value_tk['task_status'] == '1'): ?>
                                          <div>
                                            <?php $task_id = $value_tk['task_id']; ?>
                                            <?php if (!empty($value_tk['task_timer'])): ?>
                                              <?php if ($value_tk['timer_status'] == 'Start' || $value_tk['timer_status'] == 'Restart'): ?>
                                                <input type="button" class="btn btn-success input-sm restart_time" id="restart_time_<?= $task_id ?>" style="display: none;" value="Resume" onclick="restartTime('<?= $task_id ?>')">
                                                <input type="button" class="btn btn-success input-sm stop_time" id="stop_time_<?= $task_id ?>" style="background-color: red;" onclick="stopTime('<?= $task_id ?>')" value="Stop">
                                                <input type="button" class="btn btn-success input-sm hold_time" id="hold_time_<?= $task_id ?>" style="background-color: orange;" onclick="holdTime('<?= $task_id ?>')" value="Pause">
                                                <br>
                                                <span id="time_<?= $task_id ?>"><?= $value_tk['task_timer'] ?></span>
                                              <?php else: ?>
                                                <input type="button" class="btn btn-success input-sm restart_time" id="restart_time_<?= $task_id ?>" value="Resume" onclick="restartTime('<?= $task_id ?>')">
                                                <input type="button" class="btn btn-success input-sm stop_time" id="stop_time_<?= $task_id ?>" style="background-color: red;" onclick="stopTime('<?= $task_id ?>')" value="Stop">
                                                <input type="button" class="btn btn-success input-sm hold_time" id="hold_time_<?= $task_id ?>" style="background-color: orange;display: none;" onclick="holdTime('<?= $task_id ?>')" value="Pause">
                                                <br>
                                                <span id="time_<?= $task_id ?>"><?= $value_tk['task_timer'] ?></span>
                                              <?php endif; ?>
                                            <?php else: ?>
                                              <input type="button" class="btn btn-success input-sm start_time" id="start_time_<?= $task_id ?>" value="Start Work" onclick="startTime('<?= $task_id ?>')">
                                              <input type="button" class="btn btn-success input-sm restart_time" id="restart_time_<?= $task_id ?>" style="display: none;" value="Resume" onclick="restartTime('<?= $task_id ?>')">
                                              <input type="button" class="btn btn-success input-sm stop_time" id="stop_time_<?= $task_id ?>" style="background-color: red;display: none;" onclick="stopTime('<?= $task_id ?>')" value="Stop">
                                              <input type="button" class="btn btn-success input-sm hold_time" id="hold_time_<?= $task_id ?>" style="background-color: orange;display: none;" onclick="holdTime('<?= $task_id ?>')" value="Pause">
                                              <br>
                                              <span id="time_<?= $task_id ?>"></span>
                                            <?php endif; ?>
                                          </div>
                                        <?php else: ?>
                                          Complete
                                      ...
                                      <div class="row">
                                        <div class="col-sm-12 mt-3">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="e_mil_name" name="milestones_name" value="<?php echo $value_m['milestones_name']; ?>" placeholder="" required>
                                        ...
                                        <div class="col-sm-12 mt-3">
                                          <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="e_due_date" name="due_date" value="<?php echo $value_m['due_date']; ?>" placeholder="" required>
                                        ...
                                        <div class="col-sm-12 mt-3">
                                          <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="e_mile_description" name="description" required><?php echo $value_m['description']; ?></textarea>
                      ...
                      <tbody>
                        <?php if (!empty($files_list)) {
                          ...
                          $file_extension = pathinfo($file_name, PATHINFO_EXTENSION);
                           ...
                           ?>
                              <img width="100px" height="80px" src="<?php echo base_url('uploads/project/' . $value_f['file_name']); ?>">
                              <?php
                                }
                                else
                                {
 ...
 <object class="pdf" 
                                                  data="<?php echo base_url();?>uploads/project/<?php echo $value_f['file_name'];?>" width="300" height="300">
                                              </object>
                              <?php
                                }
                              ?></td>
...
<div class="modal fade" id="editdiscussionModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <form enctype="multipart/form-data">
          <div class="row">
            <div class="col-sm-12 mt-3">
              <div class="form-group">
                <label for="companyName"> Subject <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="edit_discussion_subject" name="subject" placeholder="" required>
            ...
            <div class="col-sm-12 mt-3">
              <div class="form-group">
                <label for=""> Description <span class="text-danger">*</span></label>
                <textarea class="form-control" id="edit_discuss_description" name="description" required></textarea>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" onclick="updateDiscussion()">Update</button>
      </div>
    </div>
  </div>
</div>
        ...
        <form enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-sm-12 mt-3">
              <div class="form-group">
                <label for="companyName">Order <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="m_order" placeholder="" required>
                <span id="order_msg"></span>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="taskstatusModal" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal fade" id="valErrorModal" tabindex="-1" aria-hidden="true">
    ...
    <script>
      ...
      //   const timerStatus = '<?php echo $value_tk['timer_status']; ?>';
      //   alert(timerStatus);
      //   const storedTimer = localStorage.getItem('active_timer');

      //   if ((timerStatus === 'Start' || timerStatus === 'Restart') && storedTimer) {
      //     const timerData = JSON.parse(storedTimer);

      //     const now = new Date().getTime();
      //     const timeDiff = Math.floor((now - timerData.start_time) / 1000); // elapsed in seconds

      //     const taskId = timerData.task_id;
      //     const display = document.getElementById("time_" + taskId);

      //     // startTimer(display, taskId, timerData.project_id, timeDiff);
      //     startTimer(display, taskId, timerData.project_id);

      //     // Update buttons dynamically
      //     $("#start_time_" + taskId).hide();
      //     $("#stop_time_" + taskId).show();
      //     $("#hold_time_" + taskId).show();
      //   }
      // });

      // $(document).ready(function() {
      //   const storedTimer = localStorage.getItem('active_timer');
      //   const storedTimerStatus = localStorage.getItem('active_timer_status');
      //   const storedTimerTaskId = localStorage.getItem('active_task_id');

      //   alert(storedTimerStatus);
      //   alert(storedTimerTaskId);

      //   if (storedTimer && (storedTimerStatus === 'Start' || storedTimerStatus === 'Restart')) {
      //     const timerData = JSON.parse(storedTimer);

      //     const now = new Date().getTime();
      //     const startTime = timerData.start_time;
      //     const taskId = timerData.task_id;
      //     const projectId = timerData.project_id;

      //     const timeDiff = Math.floor((now - startTime) / 1000); // elapsed in seconds

      //     const display = document.getElementById("time_" + taskId);

      //     if (display) {
      //       // Use whichever function resumes from elapsed
      //       // startTimerFromElapsed(display, taskId, projectId, timeDiff);
      //       startTimer(display, taskId, projectId, timeDiff); // adjust startTimer to support timeDiff
      //       $("#start_time_" + taskId).hide();
      //       $("#stop_time_" + taskId).show();
      //       $("#hold_time_" + taskId).show();
      //     }
      ...
      // $(document).ready(function() {
      //   const storedTimers = localStorage.getItem('active_timers');
      ...
      //       alert(`Task ID: ${taskId} - Status: ${status}`); // Optional: Debug alerts

      //       if (status === 'Start' || status === 'Restart') {
      //         const now = new Date().getTime();
      //         const timeDiff = Math.floor((now - timerData.start_time) / 1000);

      //         const display = document.getElementById("time_" + taskId);

      //         if (display) {
      //           // Resume timer from elapsed time
      //           // If you have startTimerFromElapsed, use that instead
      //           startTimer(display, taskId, timerData.project_id, timeDiff);
    ...
    <script type="text/javascript">
      ...
      function updateDiscussion() {
        ...
        if (description == '') {
          $('#edit_discuss_description').text('Description is required.');
          return false;
        } else {
          $('#edit_discuss_description').text('');
        }
      ...
      function taskFunctionEdit(task_id) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response.success) {
              ...
              $('#edit_start_date').attr('min', taskData.start_date);
        ...
        if (document.getElementById('edit_start_date').value) {
          const selectedStart = new Date(document.getElementById('edit_start_date').value);
          selectedStart.setDate(selectedStart.getDate() + 1); // optional: disable the same day
          const minEndDate = selectedStart.toISOString().split('T')[0];
          document.getElementById('edit_due_date').value = ""; // clear old value
          document.getElementById('edit_due_date').setAttribute('min', minEndDate);
        }
      });
    ...
    <script>
      ...
      function startTime(task_id) {
        const pro_id = '<?php echo base64_decode($this->uri->segment(2)); ?>';
        const display = document.getElementById("time_" + task_id);

        const startTimestamp = new Date().getTime();

        let activeTimers = JSON.parse(localStorage.getItem('active_timers')) || {};
        activeTimers[task_id] = {
          task_id: task_id,
          project_id: pro_id,
        ...
        startTimerFromElapsed(display, task_id, pro_id, 0);
        ...
        $.ajax({
          ...
          data: form_data,
          success: function(response) {
            $("#start_time_" + task_id).hide();
            $("#stop_time_" + task_id).show();
            $("#hold_time_" + task_id).show();
          }
        });
      }
      ...
      function holdTime(task_id) {
        ...
        const pro_id = '<?php echo base64_decode($this->uri->segment(2)); ?>';
        let activeTimers = JSON.parse(localStorage.getItem('active_timers')) || {};
        const timerData = activeTimers[task_id];

        if (!timerData) return;

        const elapsed = Math.floor((new Date().getTime() - timerData.start_time) / 1000);
        const form_data = new FormData();
        form_data.append('task_id', task_id);
        form_data.append('project_id', pro_id);
        form_data.append('elapsed_seconds', elapsed);

        clearInterval(timerIntervals[task_id]);

        timerData.status = 'Pause';
        localStorage.setItem('active_timers', JSON.stringify(activeTimers));
        ...
        $.ajax({
          ...
          data: form_data,
          success: function() {
            $("#restart_time_" + task_id).show();
            $("#stop_time_" + task_id).show();
            $("#hold_time_" + task_id).hide();
      ...
      function restartTime(task_id) {
        ...
        $.ajax({
          ...
          data: form_data,
          success: function(response) {
            const elapsed = response.elapsed_seconds;
            const parts = elapsed.split(":");
            const seconds = (+parts[0]) * 3600 + (+parts[1]) * 60 + (+parts[2]);

            startTimerFromElapsed(display, task_id, pro_id, seconds);

            $("#restart_time_" + task_id).hide();
            $("#stop_time_" + task_id).show();
            $("#hold_time_" + task_id).show();
            ...
            activeTimers[task_id] = {
              task_id: task_id,
              project_id: pro_id,
              start_time: new Date().getTime() - (seconds * 1000),
              status: 'Restart'
            };
            localStorage.setItem('active_timers', JSON.stringify(activeTimers));
          }
      ...
      function startTimerFromElapsed(display, task_id, pro_id, elapsedSeconds) {
        if (timerIntervals[task_id]) clearInterval(timerIntervals[task_id]);
        let timer = elapsedSeconds;

        timerIntervals[task_id] = setInterval(function() {
      ...
      $(document).ready(function() {
        const storedTimers = JSON.parse(localStorage.getItem('active_timers')) || {};
        Object.keys(storedTimers).forEach(taskId => {
          const data = storedTimers[taskId];
          if (data.status === 'Start' || data.status === 'Restart') {
            const elapsed = Math.floor((new Date().getTime() - data.start_time) / 1000);
            const display = document.getElementById("time_" + taskId);

            if (display) {
              startTimerFromElapsed(display, taskId, data.project_id, elapsed);
              $("#start_time_" + taskId).hide();
              $("#stop_time_" + taskId).show();
              $("#hold_time_" + taskId).show();
            }
