...
<div class="page-wrapper">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <!--end breadcrumb-->
      <form method="post" action="<?php echo base_url('save-project'); ?>" onsubmit="return validate_add_project(this)" enctype="multipart/form-data">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class=" row">
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="form-group">
                        <label for="inputcompany"> Project ID/Code<span class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="form-group">
                            ...
                            <select name="project_status_id" class="form-control" id="project_status_id" d>
                            <option value="">--- Select Project Status ---</option>
                            <?php
                                foreach ($project_status as $ps) 
                                {
                            ?>
                                <option value="<?php echo $ps['ps_id'];?>"><?php echo $ps['project_status_type'];?></option>  
                            <?php
                                }
                            ?>
                            </select>
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="estimated_completion_date" class="form-control" id="estimated_completion_date">
                            <span id="err7" style="color:red;"></span>
                        </div>
                    </div>
                    <div class="col-md-3 mt-3">
                        <div class="form-group">
                            <label for="estimated_completion_date">Estimated Hours <span class="text-danger">*</span></label>
                            <input type="number" name="hours" class="form-control" id="hours">
                            <span id="err_hr" style="color:red;"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select name="project_manager" class="form-control" id="project_manager" >
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <option value="<?php echo $admin['op_user_id'];?>"><?php echo $admin['user_name'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
                  ...
                  <div class="col-md-3 mt-3">
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <option value="<?php echo $mrkt['op_user_id'];?>"><?php echo $mrkt['user_name'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <select name="project_client_id" class="form-control" id="project_client_id" >
                        ...
                        <?php
                            ...
                            {
                        ?>
                            <option value="<?php echo $customer['cust_id'];?>"><?php echo $customer['company'];?> - <?php echo $customer['contact_person'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
                  ...
                  <div class="col-md-3 mt-3">
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <input type="number" name="customer_no" class="form-control" id="customer_no"
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <input type="date" name="project_handover_date" class="form-control"  id="project_handover_date">
                        </div>
                    </div>
                  ...
                  <script>
                    ...
                    <div class="col-sm-9 mt-3">
                        <div class="form-group">
                            ...
                            <textarea name="project_description" class="form-control" id="project_description" rows="3" placeholder="Project Description"></textarea>
                        </div>
                    </div>
...
<script>
 document.addEventListener('DOMContentLoaded', function () {
  ...
  function validate_add_project(ele) {//alert("11");
...
//	var subcategory = jQuery('#subcategory').val();
    ...
    { 
     ...
     { 
       //showError("Please enter project_type_id", "project_type_id"); 
       $('#err_hr').text('Please enter hours');
       hasError = 1; }
...
document.getElementById("project_start_date").addEventListener("change", function() {
    ...
    if (startDate) {
        // Set the min date of estimated completion date to the selected start date
        estimatedDate.setAttribute("min", startDate);
    } else {
        // If no start date is selected, remove the min attribute
