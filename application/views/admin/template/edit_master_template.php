...
<div class="page-wrapper">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <form method="post" action="<?php echo base_url('update-master-template/' . $res['template_id']); ?>" onsubmit="return validate_edit_template(this)" enctype="multipart/form-data">

        <div class="card ">
          <div class="card-body">
            <div class="overflow-auto">
              <ul class="nav nav-tabs flex-nowrap d-flex" id="myTab" role="tablist" style="white-space: nowrap; overflow-x: auto;">
                <!-- <ul class="nav nav-tabs flex-nowrap" id="myTab" role="tablist" style="display: flex; white-space: nowrap;"> -->
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="lead_id" class="form-control" id="lead_id" value="<?php echo @$_GET['lead'] ?>">
