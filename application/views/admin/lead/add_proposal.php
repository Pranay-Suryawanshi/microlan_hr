        ...
        <div class="page-content-wrapper">
          <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Add Proposal </div>
              <div class="ps-3">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <form method="post" class="form-validate row g-3" name="proposal_form"  action="<?php echo base_url('save-praposals/'.$res['lead_id']); ?> " onsubmit="return validate_add_proposal(this)" enctype="multipart/form-data">
                    ...
                    <!--<form class="row g-3">-->
                     ...
                     <div class="col-sm-3 mt-3">
                      ...
                      <input type="hidden" name="lead_proposal_id" class="form-control" id="lead_proposal_id"  value="<?php echo base64_decode($this->uri->segment(2)); ?>">
                      <!--<div class="col-sm-3 mt-3">
                        <div class="form-group">
                      ...
                      <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">Date<span class="text-danger">*</span></label>
                          <input type="date" class="form-control" name="date" id="date" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <span id="err_dt" style="color:red;"></span>
                      </div>
                        <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">Valid Till<span class="text-danger">*</span></label>
                       ...
                       <div class="col-sm-3 mt-3">
                        <div class="row">
                           <div class="col-sm-9">
                              <div class="form-group">
                                <label for="companyName">Select Template<span class="text-danger">*</span>  </label>
                                <select class="form-control" name="template_id" id="template_id"  data-placeholder="Select template">
                                  <option></option>
                                <?php 
                                foreach($template_list as $key => $val) {?>
                                  <option value="<?php echo $val['template_id']; ?>"><?php echo $val['title']; ?>
                                  </option>
                                <?php
                                }?>
                                </select>
                      ...
                      <hr>
                       ...
                       <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="pl_status" name="pl_status" >
                      ...
                      <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">Assigned<span class="text-danger">*</span> </label>
                       ...
                       <?php
                        ...
                        <span id="err_ass" style="color:red;"></span>
                      </div>
                      <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">To(Contact Person)  </label>
                           <input type="text" name="lp_to"  class="form-control" id="lp_to" value="<?php echo $res['contact_fullname'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">Email  </label>
                           <input type="email" name="email" class="form-control" id="email"  value="<?php echo $res['contact_email'] ?>">
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          <label for="companyName">Phone  </label>
                           <input type="number" name="phone" class="form-control" id="phone"  value="<?php echo $res['contact_phone'] ?>">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">State<span class="text-danger">*</span></label>
                       ...
                       <div class="col-sm-3 mt-3">
                        <div class="form-group">
                          <label for="companyName">Zip Code  </label>
                           <input type="text" name="zip_code" class="form-control" id=""  value="">
                        </div>
                      </div>
    ...
    <table class="table table-sm">
      ...
      <tfoot>
        <tr>
          <td colspan="4"></td>
          <td>Sub Total :</td>
          <td colspan="2"><span id="sub_total_amt">0.00</span><input type="hidden" class="form-control" id="sub_total" name="sub_total"></td>
        </tr>
        <tr>
          <td colspan="2"></td>
          <td>
          ...
          <td colspan="2"><input type="text" class="form-control" id="discount" name="discount"></td>
        </tr>
        <tr>
          <td colspan="4"></td>
          <td>Adjustment :</td>
          <td colspan="2"><input type="number" class="form-control" id="adjustment" name="adjustment" oninput="calculateAdjustment()"></td>
        </tr>
        <tr>
          <td colspan="4"></td>
          <td>GST Amount :</td>
          <td colspan="2"><input type="number" class="form-control" id="totalgstamt" name="totalgst" readonly></td>
        </tr>
        <tr>
          <td colspan="4"></td>
          <td>Total Amount :</td>
          <td colspan="2"><input type="number" class="form-control" id="stotal_amount" name="total_amount" readonly></td>
        </tr>
      </tfoot>
    </table>
  </div>
  ...
  <div class="card-footer">
    <input type="hidden" id="calTotal" name="calTotal">
  <input type="hidden" id="invoice_number" name="invoice_number" class="form-control" value="<?php echo $ivn_no; ?>">
...
<script>
  ...
  {//alert("1111");
     ...
     var lead= $('#lead_proposal_id').val();
     // var lead='<?php echo $this->uri->segment(2); ?>';
     // var lead= base64_decode(lead);
      //alert(lead);
      if(template_id=='')
     {
    ...
    // window.open("<?php echo base_url('edit-template/')?>"+template_id+'&lead='+lead, '_blank');
     var newTab= window.open("<?php echo base_url('edit-template/')?>"+template_id+'?lead_id='+lead_id+'&lead='+lead, '_blank');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateOpenTillDate() {
            ...
            // Set min date for Open Till
            openTillInput.min = dateInput.value;

            // Set Open Till to 10 days after selected date
            selectedDate.setDate(selectedDate.getDate() + 10);
            let newDate = selectedDate.toISOString().split('T')[0];

            // Set value only if it is empty or less than min
            if (!openTillInput.value || openTillInput.value < dateInput.value) {
                openTillInput.value = newDate;
            }
        }
        ...
        // Update Open Till when Date is changed
        dateInput.addEventListener("change", updateOpenTillDate);
    });
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.cart_items && response.cart_items.length > 0) {
               ...
               // $("#disTotalh").val(response.total_amount.toFixed(2));
...
function validate_add_proposal(ele) {//alert("11");
  ...
  var  assigned = $("#assigned").val();
   ...
   var template_id = $('#template_id option:selected').val();
       ...
       $('#err_dt').text('Please select  date');
        hasError = 1; }else {
            $('#err_dt').text(''); // Clear error if valid
        }

        if(assigned.trim()=='') {
       
       $('#err_ass').text('Please select assigned to');
        hasError = 1; }else {
            $('#err_ass').text(''); // Clear error if valid
        }
...
//     if (confirm('Are you sure you want to delete this item?')) {
//         $.ajax({
//             url: "<?php echo base_url('lead/delete_item_cart'); ?>",  // Make sure this endpoint handles deletion
//             type: "POST",
//             data: { cart_id: cart_id },
//             dataType: "json",
//             success: function(response) {
...
//                     $(`a[onclick="delete_item('${cart_id}');"]`).closest('tr').remove();

//                     // Optionally update the total amounts
//                    // update_totals_after_deletion(response);
//                    $("#sub_total_amt").text(response.sub_total_amount.toFixed(2));
//     $("#sub_total").val(response.sub_total_amount);

//     $("#total_amount").val(response.total_amount.toFixed(2));
//     $("#stotal_amount").val(response.total_amount.toFixed(2));
//     $("#calTotal").val(response.total_amount.toFixed(2));
...
function update_totals_after_deletion(response) {
    // Update total, subtotal, and GST fields after deletion
    $("#sub_total_amt").text(response.sub_total_amount.toFixed(2));
    $("#sub_total").val(response.sub_total_amount);
