  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="col-sm-12">
        ...
        <!-- <a href="download-pdf" class="btn btn-primary" style="float:right;">
                <i class="fa fa-download"></i>PDF</a>
                &nbsp;
              <a href="download-excel" class="btn btn-primary" style="float:right; margin-left:5px;">
                  ...
                  <tbody id="records">
                    ...
                    foreach ($leads as $value): ?>
                      <tr>
                        ...
                        <td>
                          <?php
                          $savedFilename = $value['special_attachment'] ?? '';
                          $extension = strtolower(pathinfo($savedFilename, PATHINFO_EXTENSION));
                          if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp'])) {
                            // It's an image
                            echo '<img src="' . base_url('uploads/special_attachment/' . $savedFilename) . '" alt="Image" style="width:50%;" />';
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <select class=" form-control custom-select selectedEmployeeID" tabindex="1" name="emp_id" required>
                                      ...
                                      <?php foreach ($employee as $val): ?>
                                        <option value="<?php echo $val->op_user_id ?>"
                                          <?php if ($val->op_user_id == $value->emp_id) {
                                            echo 'selected';
                                          } ?>><?php echo $val->user_name ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <select class="form-control custom-select assignleave" tabindex="1" name="leave_type_id" id="leave_type_id" required>
                                      ...
                                      <?php foreach ($leavetypes as $val): ?>
                                        ...
                                        <option value="<?php echo $val->type_id ?>"
                                          <?php if ($val->type_id == $value->leave_type_id) {
                                            echo 'selected';
                                  ...
                                  <!--  <div class="form-group">
                                      ...
                                      <input name="leave_type" type="radio" id="radio_1" data-value="Half" class="duration" value="Half Day" <?php if ($value->leave_type == 'Half Day') {
                                                                                                                                                echo 'checked';
                                                                                                                                              } ?>>
                                      <label for="radio_1">Hourly</label>
                                      <input name="leave_type" type="radio" id="radio_2" data-value="Full" class="type" value="Full Day" <?php if ($value->leave_type == 'Full Day') {
                                                                                                                                            echo 'checked';
                                                                                                                                          } ?>>
                                      <label for="radio_2">Full Day</label>
                                      <input name="leave_type" type="radio" class="with-gap duration" id="radio_3" data-value="More" value="More than One day" <?php if ($value->leave_type == 'More than One day') {
                                                                                                                                                                  echo 'checked';
                                                                                                                                                                } ?>>
                                  ...
                                  <div class="form-group" id="hourAmount">
                                      ...
                                      <select id="hourAmountVal" class=" form-control custom-select" tabindex="1" name="leave_duration" required>
                                          ...
                                          <option value="1" <?php if ($value->leave_duration == '1') {
                                                              echo 'selected';
                                                            } ?>>One hour</option>
                                          <option value="2" <?php if ($value->leave_duration == '2') {
                                                              echo 'selected';
                                                            } ?>>Two hour</option>
                                          <option value="3" <?php if ($value->leave_duration == '3') {
                                                              echo 'selected';
                                                            } ?>>Three hour</option>
                                          <option value="4" <?php if ($value->leave_duration == '4') {
                                                              echo 'selected';
                                                            } ?>>Four hour</option>
                                          <option value="5" <?php if ($value->leave_duration == '5') {
                                                              echo 'selected';
                                                            } ?>>Five hour</option>
                                          <option value="6" <?php if ($value->leave_duration == '6') {
                                                              echo 'selected';
                                                            } ?>>Six hour</option>
                                          <option value="7" <?php if ($value->leave_duration == '7') {
                                                              echo 'selected';
                                                            } ?>>Seven hour</option>
                                          <option value="8" <?php if ($value->leave_duration == '8') {
                                                              echo 'selected';
                                                            } ?>>Eight hour</option>
                                      </select>
                                  </div>
