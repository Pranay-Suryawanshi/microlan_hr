...
<div class="page-wrapper">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <!--end breadcrumb-->
      <form method="post" action="<?php echo base_url();?>save-lead" enctype="multipart/form-data" onsubmit="return validate_add_lead(this)">
                ...
                <div class=" row">
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="lead_number" name="lead_number" value="<?php echo $lead_number;?>" readonly>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                    <div class="form-group">
                        <label for="lead_date">Date of Inquiry <span class="text-danger">*</span></label>
                        <input class="form-control" type="date" id="lead_date" name="lead_date" value="<?php echo date("Y-m-d");?>" required>
                    </div>
                  </div>
                  <div class="col-md-3 mt-3">
                  <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                        <label for="">Lead Mode <span class="text-danger">*</span></label>
                        <select class="form-control" id="lead_mode" name="lead_mode_id" required>
                        <option value="">--- Select Lead Mode ---</option>
                        <?php 
                            foreach ($mode_list as $modeList) 
                            {
                                $selected = ($modeList['mode_name'] == 'Pre Qualified') ? 'selected' : '';
                        ?>
                            <option value="<?php echo $modeList['mode_id']; ?>" <?php echo $selected; ?>><?php echo $modeList['mode_name'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
                 ...
                 <!-- <div class="col-md-3 mt-3">
                    <div class="form-group">
                        ...
                        <?php
                            ...
                            {
                        ?>
                                <option value="<?php echo $leadtype['lt_id'];?>"><?php echo $leadtype['lead_type'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
                  ...
                  <div class="col-md-3 mt-3">
                    <div class="row">
                        ...
                        <select class="form-control" id="lead_status_id" name="lead_status_id" required>
                        <option value="">--- Select Lead Status ---</option>
                        <?php
                            foreach ($leadstatus_list as $leadstatus) 
                            {
                                $selected = ($leadstatus['name'] == 'New Lead') ? 'selected' : '';
                        ?>
                            <option value="<?php echo $leadstatus['is_id']; ?>" <?php echo $selected; ?>><?php echo $leadstatus['name'];?></option>  
                        <?php
                            }
                        ?>
                        </select>
    ...
    foreach ($result as $val) 
    {
        ...
        // $selected = ($val['user_name'] == 'New Lead') ? 'selected' : '';
?>
                        ...
                        <div class=" row">
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onchange="checkMobileNumber(this.value);" id="phoneNumber" name="contact_phone"  placeholder="Enter phone number">
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="contact_fullname"  placeholder="Enter full name">
                                </div>
                            ...
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="contact_email"  placeholder="Enter email">
                                </div>
                            </div>
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label for="company">Company</label>
                                    <input type="text" class="form-control" id="company" name="contact_company" placeholder="Enter company name">
                                </div>
                            </div>
                            <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label for="jobTitle">Job Title</label>
                                    <input type="text" class="form-control" id="jobTitle" name="contact_jobtitle" placeholder="Enter job title">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <button type="button"  class="btn btn-primary cat_btn" style="margin-top:20px; " data-toggle="modal" data-target="#PartnerModal"><i class="fa fa-plus"></i></button>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="communication_pref" name="communication_pref">
                                        ...
                                        <?php
                                            ...
                                            {
                                                $selected = ($comList['com_name'] == 'Phone') ? 'selected' : '';
                                        ?>
                                            <option value="<?php echo $comList['com_id']; ?>" <?php echo $selected; ?>><?php echo $comList['com_name'];?></option>  
                                        <?php
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="col-sm-3">
                        <button type="button"  class="btn btn-primary cat_btn" style="margin-top:20px; " data-toggle="modal" data-target="#ComModal"><i class="fa fa-plus"></i></button>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="time" id="communication_time" name="communication_time">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        {
                                    ?>
                                        <option value="<?php echo $pt['pt_id'];?>"><?php echo $pt['project_type'];?></option>  
                                    <?php
                                        }
                                    ?>
                                    </select>
                        ...
                        <button type="button"  class="btn btn-primary cat_btn" style="margin-top:20px; " data-toggle="modal" data-target="#RequirementModal"><i class="fa fa-plus"></i></button>
                            ...
                            <!--<div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <select class="multiselect1 form-control" multiple="multiple" name="project_id" required>
                                        <?php 
                                        foreach($project_list as $key => $value) {?> <option value="<?php echo $value['project_id']; ?>"> <?php echo $value['project_name']; ?> </option> <?php
                                    }?>
                                    </select>
                                </div>
                            </div>-->
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    <label for="possession_expected_period">Expected Period (In days)</label>
                                    <input class="form-control" type="number" id="possession_expected_period" name="possession_expected_period">
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    <label for="budget_range">Budget Range</label>
                                    <input class="form-control" type="text" id="budget_range" name="budget_range">
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    <label for="special_requirement">Special Requirements</label>
                                    <textarea class="form-control" id="special_requirement" name="special_requirement"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4 mt-3">
                            <div class="form-group">
                                    <label for="special_attachment">Attach File</label>
                                    <input type="file" class="form-control" id="special_attachment" name="special_attachment" />
                                </div>
...
<div class="modal" id="ComModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
               <center><span id="msg3"></span></center>
                <form enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="inputName">Enter Communication Preference</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary add_com">Add</button>
            </div>
        </div>
    </div>
</div>
...
<!-- <div id="myModal" class="modal fade">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="inputName">Enter category name</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary add_cat">Add</button>
            </div>
        </div>
        </div>
    </div> -->
...
$(".add_com").click(function(){
  ...
  var com_name=$('#com_name').val();
      if(com_name=='')
      {
        $('#com_msg').text('Communication Preference  is required.');
        return false;
  ...
  var form_data = new FormData(); 
      form_data.append('com_name',com_name);
      
      $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('ajaxComPre'); ?>",
                     dataType: 'text', 
                      cache: false,
                      contentType: false,
                      processData: false,
  ...
  jQuery.ajax({
        dataType: 'html',
        type: "POST",
        url: "<?php echo base_url();?>get-ComPre-list",
        data: {},
        beforeSend: function(){ },
        success: function(res){
            $("#communication_pref").html(res);
        },
        error:function(error,message){
            console.log(message);
        }
...
function validate_add_lead(ele) {//alert("11");
