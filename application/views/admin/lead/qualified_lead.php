  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Qualified Lead</div>
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Qualified Lead List</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="col-sm-12 mt-5">
              <div class="table-responsive">
                <table id="ld_list" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody id="records">
                    <?php $i = 1;
                    foreach ($qualified_list as $value): ?>
                      <tr>
...
var form_data = new FormData(); 
    ...
    $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('lead/filter_qualified_data'); ?>",
                   dataType: 'html', 
                    cache: false,
                    contentType: false,
                    processData: false,
