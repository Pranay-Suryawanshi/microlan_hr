                            ...
                            <form class="row g-3" id="frmadminlogin" novalidate="true" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mt-3 text-center">
                                        ...
                                        <?php } else { ?>
                                            <img src="<?php echo base_url(); ?>uploads/profile/<?php echo $user[0]['profile_photo']; ?>"
                                                id="imagePreview" style="width: 125px; border-radius: 50%; height: 125px"
                                                onclick="document.getElementById('fileInput').click();">
                                        <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label for="user_name">Enter User Name</label><span
                                                class="text-danger">*</span>
                                            <input name="user_name" type="text" id="user_name" value="<?php echo $user[0]['user_name']; ?>" class="form-control"
                                                autocomplete="off">
                                            <input name="op_user_id" type="hidden" id="op_user_id" value="<?php echo $user[0]['op_user_id']; ?>" class="form-control"
                                                autocomplete="off">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="email" type="text" id="email" value="<?php echo $user[0]['email']; ?>" class="form-control"
                                                autocomplete="off">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label for="contact_no">Contact Number</label><span
                                                class="text-danger">*</span>
                                            <input name="contact_no" type="text" oninput="restrictToNumbers(event)" maxlength="10" value="<?php echo $user[0]['contact_no']; ?>" id="contact_no" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="aadhar_no" oninput="restrictToNumbers(event)" maxlength="12" type="text" value="<?php echo $user[0]['aadhar_no']; ?>" id="aadhar_no" class="form-control"
                                                autocomplete="off">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="pan_no" type="text" maxlength="10" value="<?php echo $user[0]['pan_no']; ?>" id="pan_no" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role_id" id="role_id">
                                                ...
                                                <?php foreach ($user_role_list as $user_role) { ?>
                                                    <option value="<?php echo $user_role['role_id'] ?>" <?php if ($user[0]['role_id'] == $user_role['role_id']) {
                                                                                                            echo "selected";
                                                                                                        } ?>
                                                        data-value="<?php echo $user_role['is_ho_user']; ?>">
                                                        <?php echo $user_role['role_name']; ?></option>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="user_id" type="text" value="<?php echo $user[0]['user_id']; ?>" id="user_id" class="form-control"
                                                autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="designation_id" id="designation_id">
                                                ...
                                                <?php foreach ($designationlist as $designation) { ?>
                                                    <option value="<?php echo $designation['id'] ?>" <?php if ($user[0]['designation_id'] == $designation['id']) {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control rounded-0" id="address" rows="3"
                                            name="address"> <?php echo $user[0]['address']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $user[0]['account_name']; ?>" name="account_name"
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<?php echo $user[0]['account_no']; ?>" name="account_no" id="account_no"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bank_name" value="<?php echo $user[0]['bank_name']; ?>" id="bank_name" class="form-control"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $user[0]['branch_name']; ?>" name="branch_name" id="branch_name"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $user[0]['ifsc_code']; ?>" name="ifsc_code" id="ifsc_code"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="swift_code" value="<?php echo $user[0]['swift_code']; ?>" id="swift_code" class="form-control"
                                                autocomplete="off">
                                        </div>
                                    </div>
