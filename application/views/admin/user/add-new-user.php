                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="row g-3" id="frmadminlogin" novalidate="true" method="post"
                                action="<?php echo base_url(); ?>submit-user" onsubmit="return validate_user(this);">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label for="user_name">Enter User Name</label><span class="text-danger">*</span>
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="contact_no" type="text" oninput="restrictToNumbers(event)" maxlength="10" id="contact_no" class="form-control"
                                                autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="aadhar_no" oninput="restrictToNumbers(event)" maxlength="12" type="text" id="aadhar_no" class="form-control"
                                                autocomplete="off">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input name="pan_no" type="text" maxlength="10" id="pan_no" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            <label for="c_password">Enter Confirm Password</label><span
                                                class="text-danger">*</span>
                                            <input name="c_password" type="password" id="c_password"
                                                class="form-control" autocomplete="off">
                                            <span id="c_password_error" style="color: red; display: none;">Confirm
                                                password is
                                                required.</span>
                                            <span id="c_password_not_match_error"
                                                style="color: red; display: none;">Password is Invalid.</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function validate_user() {
            ...
            ['user_name', 'email', 'contact_no', 'role_id', 'designation_id', 'user_id', 'password', 'c_password'].forEach(function (field) {
            ...
            if (isValid) {
                ...
                let imputcpassword = document.getElementById('c_password');
                let errorElement = document.getElementById('c_password_not_match_error');
                if (imputpassword.value.trim() != imputcpassword.value.trim()) {
                    errorElement.style.display = 'block';  // Show error message if field is empty
                    isValid = false;
                } else {
                    errorElement.style.display = 'none';   // Hide error message if field is filled
